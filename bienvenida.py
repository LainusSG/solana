...
st.markdown('<p style="display: block; text-align:center; font-size: 25px;color: #000;">Para obtener información sobre avisos legales, de protección de datos</p>', unsafe_allow_html=True)
st.markdown('<p style="display: block; text-align:center; font-size: 25px;color: #000;">y desarrollo ir a "Acerca de"</p>', unsafe_allow_html=True)
